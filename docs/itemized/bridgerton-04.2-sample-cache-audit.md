...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2026/refs/heads/main/data/geojson.cumulative/bridgerton-04.2-cumulative-aggregate.geojson.gz" data-map-title="Bridgerton — bridgerton-04.2" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Bridgerton (bridgerton-04.2) cumulative data map in new window" title="Opens interactive map for Bridgerton (bridgerton-04.2) data">Swarm Detail</a>
