...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2026/refs/heads/main/data/geojson.cumulative/bear-00-cumulative-aggregate.geojson.gz" data-map-title="The Bear — bear-00" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open The Bear (bear-00) cumulative data map in new window" title="Opens interactive map for The Bear (bear-00) data">Swarm Detail</a>
