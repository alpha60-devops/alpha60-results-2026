...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2026/refs/heads/main/data/geojson.cumulative/zootopia-2-cumulative-aggregate.geojson.gz" data-map-title="Zootopia — zootopia-2" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Zootopia (zootopia-2) cumulative data map in new window" title="Opens interactive map for Zootopia (zootopia-2) data">Swarm Detail</a>
