...
### <a href="https://raw.githubusercontent.com/alpha60-devops/alpha60-results-2026/refs/heads/main/data/geojson.cumulative/olympics-2026-cumulative-aggregate.geojson.gz" data-map-title="Olympics — olympics-2026" onclick="leaflet_map_open_window(this.href, this.dataset.mapTitle); return false;" class="table-link" aria-label="Open Olympics (olympics-2026) cumulative data map in new window" title="Opens interactive map for Olympics (olympics-2026) data">Swarm Detail</a>
